...
public final class OrderServiceFixture {
	...
	public static Usuario gerarUsuarioAdmin() {
		return new Usuario(UUID.fromString("99999999-9999-9999-9999-999999999998"), "admin@oficina360.com", "123456",
				ADMIN, "12345678801");
	}

	public static Usuario gerarUsuarioCliente() {

		return new Usuario(UUID.fromString("99999999-9999-9999-9999-999999999998"), "cliente@oficina360.com", "123456",
				CLIENTE, "12345678901");
	}

	public static Usuario gerarUsuarioCliente1() {
		return new Usuario(UUID.fromString("99999999-9999-9999-9999-999999999977"), "cliente1@oficina360.com", "123456",
				CLIENTE, "12345678801");

	}

	public static Usuario gerarUsuarioCliente2() {
		return new Usuario(UUID.fromString("99999999-9999-9999-9999-999999998877"), "cliente2@oficina360.com", "123456",
				CLIENTE, "98765432100");
	}

	public static DiagnosticoDTO diagnosticoComServicoInexistente() {

		return new DiagnosticoDTO(List.of("SERVICO-INEXISTENTE"),
				List.of(new DiagnosticoEstoqueDTO("PNEU-205-55-R16", 4)));
	}

	public static DiagnosticoDTO diagnosticoComServicoValidoEInvalido() {

		return new DiagnosticoDTO(List.of("BALANCEAMENTO", "SERVICO-INEXISTENTE"),
				List.of(new DiagnosticoEstoqueDTO("PNEU-205-55-R16", 4)));
	}

	public static DiagnosticoDTO diagnosticoComItemEstoqueInexistente() {

		return new DiagnosticoDTO(List.of("BALANCEAMENTO"), List.of(new DiagnosticoEstoqueDTO("ITEM-INEXISTENTE", 2)));
	}

	public static DiagnosticoDTO diagnosticoComEstoqueValidoEInvalido() {

		return new DiagnosticoDTO(List.of("BALANCEAMENTO"), List.of(new DiagnosticoEstoqueDTO("PNEU-205-55-R16", 1),
